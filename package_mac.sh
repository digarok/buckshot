...
curl -s -L -o b2d.zip https://github.com/digarok/b2d/releases/download/v1.5/b2d-macos-latest-v1.5.zip
...
curl -s -L -o image2shr https://github.com/digarok/image2shr/releases/download/v0.2.0/image2shr-darwin-${GOARCH}
chmod +x image2shr
